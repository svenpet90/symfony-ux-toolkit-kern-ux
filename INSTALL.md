...
This kit provides ready-to-use and fully-customizable UI Twig components based on [KERN-UX 2.8](https://www.kern-ux.de/) components's **design**.

Please note that not every KERN-UX component is available in this kit, but we are working on it!

## Requirements

This kit requires KERN-UX 2.8 to work:
